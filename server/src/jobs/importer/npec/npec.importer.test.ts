  ...
  const expectedDataMap = {
    ...
    "Referentiel-des-NPEC_vMAJ-09.04.2024.xlsx": {
      source: [
        ...
        {
          certificateur: "LYCEE PROFESSIONNEL LES HUISSELETS",
          cpne_code: "2",
          cpne_libelle: "CNPE des sociétés financières",
          date_applicabilite: new Date("2023-10-15T00:00:00.000Z"),
          diplome_code: null,
          diplome_libelle: "TITRE",
          formation_libelle: "Coordonnateur en Prévention des Risques",
          idcc: null,
          npec: 7750,
          procedure: null,
          rncp: "RNCP31946/RNCP36989",
          statut: "A",
          type: "npec",
        },
        {
