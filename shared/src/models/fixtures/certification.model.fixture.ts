...
export type ICertificationInternalFixtureInput = ICertificationFixtureInput & Partial<Pick<ICertificationInternal, "_id" | "created_at" | "updated_at">>

export function generateCertificationInternalFixture(data?: ICertificationInternalFixtureInput): ICertificationInternal {
  return {
    _id: new ObjectId(),
