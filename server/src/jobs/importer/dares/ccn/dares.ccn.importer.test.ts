...
describe("runConventionCollectivesImporter", () => {
  ...
  it("should import ccn data", async () => {
    ...
    scope.get("/dialogue-social/negociation-collective/article/conventions-collectives-nomenclatures").reply(200, await readFile(join(fixtureDir, "article.html"), "utf-8"))
    scope
      .head("/sites/travail-emploi/files/2024-10/Liste%20des%20conventions%20collectives%20et%20de%20leur%20code%20IDCC%20-%20octobre%202024.xlsx")
      .reply(200, "", { "last-modified": "Wed, 02 Oct 2024 14:55:22 GMT" })
    scope
      .get("/sites/travail-emploi/files/2024-10/Liste%20des%20conventions%20collectives%20et%20de%20leur%20code%20IDCC%20-%20octobre%202024.xlsx")
    ...
    expect(result).toEqual([
      ...
      },
      {
        data: {
          idcc: 29,
          titre: "Convention collective nationale des établissements privés d'hospitalisation, de soins, de cure et de garde à but non lucratif (FEHAP, convention de 1951)",
        },
        date_import: now,
        import_id: imports[0]._id,
      },
  ...
  it("should skip if file is up to date", async () => {
    ...
    const initialData = [
      ...
      },
      {
        ...
        data: {
          idcc: 158,
          titre: "Convention collective nationale du travail mécanique du bois, des scieries, du négoce et de l'importation des bois",
        },
        date_import: yesterday,
        import_id: initialImport._id,
      },
