...
describe("runConventionCollectivesImporter", () => {
  ...
  it("should import ccn data", async () => {
    ...
    nock("https://www.data.gouv.fr/fr").get(`/datasets/r/02b67492-5243-44e8-8dd1-0cb3f90f35ff`).reply(200, createReadStream(dataFixture))
    ...
    await getDbCollection("source.kali.ccn").insertMany([
      {
        ...
        data: {
          ...
          titre: "Accord professionnel du 21 juillet 2022 relatif à la reconversion ou la promotion par l'alternance « Pro-A »",
