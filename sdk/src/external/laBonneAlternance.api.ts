...
export const zJobRecruiterLba = z.object({
  ...
  workplace_naf_code: zJobRecruiter.shape.workplace.shape.domain.shape.naf.unwrap().shape.code.nullable(),
  workplace_naf_label: zJobRecruiter.shape.workplace.shape.domain.shape.naf.unwrap().shape.label,
...
export const zJobOfferLba = zJobRecruiterLba
  ...
  .extend({
    ...
    offer_creation: zJobOffer.shape.offer.shape.publication.shape.creation,
    offer_expiration: zJobOffer.shape.offer.shape.publication.shape.expiration,
