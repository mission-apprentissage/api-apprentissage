...
program.command("migrations:up").description("Run migrations up").option("-q, --queued", "Run job asynchronously", false).action(createJobAction("migrations:up"))

program.command("migrations:status").description("Check migrations status").option("-q, --queued", "Run job asynchronously", false).action(createJobAction("migrations:status"))
...
program.command("import:kit_apprentissage").option("-q, --queued", "Run job asynchronously", false).action(createJobAction("import:kit_apprentissage"))
program.command("import:formation").option("-q, --queued", "Run job asynchronously", false).action(createJobAction("import:formation"))
program.command("import:organismes").option("-q, --queued", "Run job asynchronously", false).action(createJobAction("import:organismes"))
program.command("import:communes").option("-q, --queued", "Run job asynchronously", false).action(createJobAction("import:communes"))
program.command("import:certifications").option("-q, --queued", "Run job asynchronously", false).action(createJobAction("import:certifications"))
program.command("import:catalogue").option("-q, --queued", "Run job asynchronously", false).action(createJobAction("import:catalogue"))
program.command("import:referentiel").option("-q, --queued", "Run job asynchronously", false).action(createJobAction("import:referentiel"))
program.command("import:bcn").option("-q, --queued", "Run job asynchronously", false).action(createJobAction("import:bcn"))
program.command("import:acce").option("-q, --queued", "Run job asynchronously", false).action(createJobAction("import:acce"))
program.command("import:france_competence").option("-q, --queued", "Run job asynchronously", false).action(createJobAction("import:france_competence"))
...
program
  ...
  .action(async ({ email, expiresIn }) => {
    ...
    const token = await createAuthToken({ user, organisation, apiKeyEnv: "production" }, expiresIn)
    logger.info({ token })
