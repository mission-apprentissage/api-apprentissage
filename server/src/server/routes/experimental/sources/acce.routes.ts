...
import type { ISourceAcce, ISourceAcceUai, ISourceAcceUaiFille, ISourceAcceUaiMere, ISourceAcceUaiSpec, ISourceAcceUaiZone } from "shared/models/source/acce/source.acce.model"
...
async function getCursor<T extends ISourceAcce>(source: T["source"], query: ISourceAcceQuerystring): Promise<AbstractCursor<T["data"]> | null> {
...
export const sourceAcceRoutes = ({ server }: { server: Server }) => {
  server.get(
    ...
    async (request, response) => {
      ...
      return response.status(200).header("Content-Type", "application/json").send(createResponseStream(cursor, zRoutes.get["/experimental/source/acce"].response["200"]))
    }
  )
  ...
  server.get(
    ...
    async (request, response) => {
      ...
      return response.status(200).header("Content-Type", "application/json").send(createResponseStream(cursor, zRoutes.get["/experimental/source/acce/zone"].response["200"]))
    }
  )
  ...
  server.get(
    ...
    async (request, response) => {
      ...
      return response.status(200).header("Content-Type", "application/json").send(createResponseStream(cursor, zRoutes.get["/experimental/source/acce/specialite"].response["200"]))
    }
  )
  ...
  server.get(
    ...
    async (request, response) => {
      ...
      return response.status(200).header("Content-Type", "application/json").send(createResponseStream(cursor, zRoutes.get["/experimental/source/acce/mere"].response["200"]))
    }
  )
  ...
  server.get(
    ...
    async (request, response) => {
      ...
      return response.status(200).header("Content-Type", "application/json").send(createResponseStream(cursor, zRoutes.get["/experimental/source/acce/fille"].response["200"]))
    }
  )
}
