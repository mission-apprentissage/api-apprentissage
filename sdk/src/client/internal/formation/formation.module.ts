...
export type FormationModule = {
  recherche(querystring: Omit<IApiQuery<IApiGetRoutes["/formation/v1/search"]>, "page_index">): AsyncGenerator<IFormation[], void, void>
}

export function buildFormationModule(apiClient: ApiClient): FormationModule {
  return {
    recherche: async function* (querystring: Omit<IApiQuery<IApiGetRoutes["/formation/v1/search"]>, "page_index">): AsyncGenerator<IFormation[], void, void> {
      const {
        data: firstPageData,
