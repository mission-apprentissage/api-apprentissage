...
export type OrganismeModule = {
  ...
  export(querystring: Omit<IApiQuery<IApiGetRoutes["/organisme/v1/export"]>, "page_index">): AsyncGenerator<IOrganisme[], void, void>
}
...
export function buildOrganismeModule(apiClient: ApiClient): OrganismeModule {
  ...
  return {
    recherche: async (querystring: IApiQuery<IApiGetRoutes["/organisme/v1/recherche"]>): Promise<IRechercheOrganismeResponse> => {
    ...
    export: async function* (querystring: Omit<IApiQuery<IApiGetRoutes["/organisme/v1/export"]>, "page_index">): AsyncGenerator<IOrganisme[], void, void> {
      const {
        data: firstPageData,
