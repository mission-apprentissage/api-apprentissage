...
import type { OperationObject, ParameterObject, PathsObject, ReferenceObject, ResponsesObject, SchemaObject, SchemasObject } from "openapi3-ts/oas31"
...
function generateOpenApiResponsesObject<R extends IApiRouteSchema["response"]>(response: R, registry: $ZodRegistry<RegistryMeta>): ResponsesObject | null {
...
function generateOpenApiRequest(route: IApiRouteSchema, registry: $ZodRegistry<RegistryMeta>): Pick<OperationObject, "requestBody" | "parameters"> {
...
export function generateComponents(registry: $ZodRegistry<RegistryMeta>, io: "input" | "output"): { schemas: Record<string, SchemasObject> } {
