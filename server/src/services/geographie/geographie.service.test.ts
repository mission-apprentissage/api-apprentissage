...
import { communeFixtures, getMissionLocaleFixtureFromSource, missionLocaleFixtures } from "shared/models/fixtures/commune.model.fixture"
...
describe("searchMissionLocales", () => {
  ...
  it('should filter by "geolocalisation" and sort by distance', async () => {
    ...
    expect(data50).toEqual([getMissionLocaleFixtureFromSource(missionLocaleFixtures[374]), getMissionLocaleFixtureFromSource(missionLocaleFixtures[226])])
  })
})
