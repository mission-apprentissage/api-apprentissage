...
import { departementModelDoc } from "api-alternance-sdk/internal";
...
export default async function ListeDepartementsPage({ params: { lang } }: PropsWithLangParams) {
  ...
  return (
    <Container maxWidth="xl" sx={{ marginTop: fr.spacing("2w"), marginBottom: fr.spacing("9w") }}>
      <Breadcrumb
        currentPageLabel={PAGES.static.recuperationDepartements.getTitle(lang, t)}
        homeLinkProps={{
          href: "/",
        }}
        segments={[
      ...
      <CatalogueHeadline
        ...
        dangerousHtmlDescriptions={[t("recuperationDepartements.summary", {})]}
        frequenceMiseAJour="daily"
      />
      <CatalogueData
        models={{
          [t("recuperationDepartements.variant")]: departementModelDoc,
        }}
        lang={lang}
        t={t}
      />
      <DataSources sources={departementModelDoc.sources} />
    </Container>
  );
}
