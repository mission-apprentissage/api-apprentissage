...
<br/>Opportunities are updated once a day at 3:00 AM Paris time.<br /><br />**Rate limit**: 2 calls per minute, per consumer.`,
...
<br/>Les opportunités sont mises à jour une fois par jour à 3h du matin heure de Paris.<br /><br />**Limite de débit** : 2 appels par minute, par consommateur.`,
  },
  response: {
