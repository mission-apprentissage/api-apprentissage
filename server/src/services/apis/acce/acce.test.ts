...
describe("downloadCsvExtraction", () => {
  ...
  it("should download response and return a readStream", async () => {
    ...
    scope
      ...
      .reply(200, 'You should have a look at this "https://acce.depp.education.fr/acce/getextract.php?ex_id=some-random-id"')

    scope.get("/getextract.php?ex_id=some-random-id").matchHeader("Cookie", "men_default=session_token").reply(200, "Here is your data", {
  ...
  it("should error when generate extract doesn't return extract_id", async () => {
    ...
    scope
      ...
      .reply(200, 'You should have a look at this "https://acce.depp.education.fr/acce/the_api_changed?ex_id=some-random-id"')
