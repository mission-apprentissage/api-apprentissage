...
export function buildGeographieModule(apiClient: ApiClient): GeographieModule {
  ...
  return {
    rechercheCommune: async (querystring: IApiQuery<IApiGetRoutes["/geographie/v1/commune/search"]>): Promise<ICommune[]> => {
    ...
    listMissionLocales: async (querystring: IApiQuery<IApiGetRoutes["/geographie/v1/mission-locale"]> = {}): Promise<IMissionLocale[]> => {
