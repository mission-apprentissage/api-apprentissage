...
export const offerReadModelDoc = {
  ...
  sections: {
    identifier: {
      name: recruiterModelDoc.sections.identifier.name,
      _: {
        identifier: {
          ...recruiterModelDoc.sections.identifier._.identifier,
          _: {
            id: {
    ...
    workplace: recruiterModelDoc.sections.workplace,
    apply: recruiterModelDoc.sections.apply,
  },
