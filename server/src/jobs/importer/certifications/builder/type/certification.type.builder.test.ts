...
import { buildCertificationType } from "./certification.type.builder.js"
...
describe("buildCertificationType", () => {
  ...
  describe("type.voie_acces", () => {
    ...
    it('should throw when "Si_Jury" is not part of enum', () => {
      ...
      expect(() => buildCertificationType({ france_competence: fc })).toThrow("import.certifications: unexpected voie d'acces value")
    })
  })
})
