...
export function areSourcesUpdated(lastImportSources: Record<string, { import_date: Date }> | null | undefined, currentSources: Record<string, { import_date: Date }>): boolean {
