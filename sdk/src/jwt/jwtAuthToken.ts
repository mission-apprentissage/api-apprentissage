...
export async function parseApiAlternanceToken(params: IParseApiAlternanceTokenParams): Promise<IParseApiAlternanceTokenResult> {
  try {
...
export async function createApiAlternanceToken({ data, privateKey, expiresIn }: ICreateApiAlternanceTokenParams): Promise<string> {
