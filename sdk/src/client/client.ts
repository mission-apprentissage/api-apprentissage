...
import type { IApiDeleteRoutes, IApiGetRoutes, IApiPostRoutes, IApiPutRoutes, IApiRequest, IApiResponse } from "../routes/index.js"
...
type OptionsGet = {
  [Prop in keyof Pick<IApiRouteSchema, "params" | "querystring" | "headers">]: IApiRouteSchema[Prop] extends $ZodType ? z.input<IApiRouteSchema[Prop]> : never
}

type OptionsWrite = {
  [Prop in keyof Pick<IApiRouteSchemaWrite, "params" | "querystring" | "headers" | "body">]: IApiRouteSchemaWrite[Prop] extends $ZodType
    ? z.input<IApiRouteSchemaWrite[Prop]>
    : never
}
...
class ApiClient {
  ...
  private buildRequestInit(method: RequestInit["method"], options: IRequestOptions, rawOptions?: FetchOptions): RequestInit {
  ...
  async put<P extends keyof IApiPutRoutes, S extends IApiPutRoutes[P] = IApiPutRoutes[P]>(path: P, options: IApiRequest<S>, rawOptions?: FetchOptions): Promise<IApiResponse<S>> {
